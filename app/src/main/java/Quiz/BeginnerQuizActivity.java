...
public class BeginnerQuizActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prd    = new ProgressDialog(BeginnerQuizActivity.this);
        ...
        try
        {
            DatabaseReference d = FirebaseDatabase.getInstance().getReference("Questions").child("Beginner");
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    for(int i = 0 ; i<15; i++)
                    {
                        DatabaseReference data = FirebaseDatabase.getInstance().getReference(
                                "Questions").child("Beginner").child(quesid.get(i));
    ...
    private void updateQuestion() {
        ...
        {
            //reference =
            //  FirebaseDatabase.getInstance().getReference().child("Questions/Beginner").child
            //  (String.valueOf(computerCount));
            total++;
